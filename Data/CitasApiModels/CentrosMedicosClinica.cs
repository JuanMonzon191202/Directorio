...
namespace CitasMedicasAPI.Data.CitasApiModels
{
    public partial class CentrosMedicosClinica
    {
        ...
        public int? IdUsuario { get; set; } // Agregado para relacionar con el modelo de Usuario
        ...
        public virtual Usuario? IdUsuarioNavigation { get; set; } // Agregado para la relación con Usuario
    }
}
